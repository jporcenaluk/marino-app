  ...
  return (
    <div className="p-4 max-w-md mx-auto">
      ...
      <section className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-1 p-4 flex items-center justify-center"><a href="https://github.com/jporcenaluk/marino-app" className="btn btn-primary w-full">Source Code!</a></div>
        ...
        <div className="col-span-1 p-4 flex items-center justify-center"><a href="https://ourworldindata.org/travel-carbon-footprint" className="btn btn-primary w-full">Emissions Report!</a></div>
...
export default Story04Conclusion;