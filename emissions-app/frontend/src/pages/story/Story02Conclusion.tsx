...
function Story02Next() {
  ...
  return (
    ...
    <section className="grid grid-cols-3 gap-4">
      ...
      <div className="p-4 flex items-center justify-center"><a href="https://github.com/jporcenaluk/marino-app" className="btn btn-primary text-xs px-4 py-2 rounded w-full">Source Code!</a></div>
      ...
      <div className="p-4 flex items-center justify-center"><a href="https://ourworldindata.org/travel-carbon-footprint" className="btn btn-primary text-xs px-4 py-2 rounded w-full">Emissions Report!</a></div>
      ...
      <div className="p-4 flex items-center justify-center">
        <button
          className="btn btn-primary text-xs px-4 py-2 rounded w-full"
          onClick={() => {
