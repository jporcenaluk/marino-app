...
import Story03Answers from './pages/story/Story03Answers';
import Story04Conclusion from './pages/story/Story04Conclusion';
      ...
      <BrowserRouter>
        <Routes>
            <Route element={<StoryLayout />}>
                ...
                <Route path="/story/3" element={<Story03Answers />} />
                <Route path="/story/4" element={<Story04Conclusion />} />
            </Route>
